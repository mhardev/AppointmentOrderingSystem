$(document).ready(function () {
    ...
    $('#prodTbl').on('click', '#rtvBtn', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: 'APIs/ArchiveAPI/getRetrieved.php',
                    type: 'POST',
                    data: {
                        id: rowId,
                    },
    ...
    $('#prodTbl').on('click', '#delBtn', function () {
        ...
        Swal.fire({
            icon: "question",
            text: "Are you sure you want to permanent deleted this product?",
            showCancelButton: true,
            confirmButtonText: "Yes"
        }).then((result) => {
            if (result.isConfirmed) {
                $.ajax({
                    url: 'APIs/ArchiveAPI/getDelete.php',
                    type: 'POST',
                    data: {
                        id: rowId,
                    },
    ...
    $.ajax({
        url: 'APIs/ArchiveAPI/getArchived.php',
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            getData(data)
