...
<body>
    ...
    ?>
        <main class="main-container">
            <div class="main-title">
                <p class="font-weight-bold">Audit Trails</p>
            </div>
            <div class="table-responsive">
                <table id="recAccTbl" class="table table-striped table-sm" style="width:100%">
                    <thead>
                        <tr class="table-dark">
                            <th>Id</th>
                            <th>User Id</th>
    ...
    <script src="Root/js/AuditTrail/Audit.js"></script>
