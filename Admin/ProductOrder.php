...
<body>
  <div class="grid-container">
    ...
    <div class="main-title">
        <p class="font-weight-bold">Product Orders</p>
      </div>
      <div class="table-responsive">
        <table id="prodOrdTbl" class="table table-striped table-sm" style="width:100%">
          <thead>
            <tr class="table-dark">
              <th>Order Id</th>
              <th>Name</th>
  ...
  <script src="Root/js/Product/ProductOrder.js"></script>
