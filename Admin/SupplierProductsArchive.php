...
<body>
    ...
    ?>
        <main class="main-container">
            <div class="main-title">
                <p class="font-weight-bold">Archive Supplier Products</p>
            </div>
            <div class="table-responsive">
                <table id="suppProdTbl" class="table table-striped table-sm" style="width:100%">
                    <thead>
                        <tr class="table-dark">
                            <th>Id</th>
                            <th>Supplier Id</th>
    ...
    <script src="Root/js/Archive/SupplierProductsArchive.js"></script>
