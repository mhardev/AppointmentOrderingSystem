...
<body>
    ...
    ?>
        <main class="main-container">
            <div class="main-title">
                <p class="font-weight-bold">Archive Supplier Details</p>
            </div>
            <div class="table-responsive">
                <table id="suppTbl" class="table table-striped table-sm" style="width:100%">
                    <thead>
                        <tr class="table-dark">
                            <th>Supplier ID</th>
                            <th>Supplier Name</th>
    ...
    <script src="Root/js/Archive/SupplierArchive.js"></script>
