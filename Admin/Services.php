...
<body>
  <div class="grid-container">
    ...
    <main class="main-container">
      ...
      <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addService">
        <span class="mx-1"><i class="bi bi-plus-circle"></i></span>Add Service
      </button>
      <div class="table-responsive">
        <table id="servTbl" class="table table-striped table-sm" style="width:100%">
          <thead>
            <tr class="table-dark">
              <th>Id</th>
              <th>Service Name</th>
              <th>Service Price</th>
              <th class="text-center" style="width: 235px;">Actions</th>
            </tr>
          </thead>
  ...
  <script src="Root/js/Services/Services.js"></script>
